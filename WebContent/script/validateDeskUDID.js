...
$(document).ready(function(){
	...
	$.fn.LocalST = function(user,pass){
		if($("#remember").is(":checked")) {
			...
			try {
				...
				noty({text:"Error eliminado PASS", type : "error", timeout: 4000});
		    	return false;
			}
		}		
	};								
    ...
    $('#dologin').click(function(e){
	    ...
	    if(conexion=="false"){				    		    	
	    	noty({text:"Necesita una conexion 3G o WIFI para acceder", type : "warning", timeout: 4000});
	    	$(this).removeClass("processing");
	    	return false;
	     }else if(user==""){				    	 		     
		     noty({text:"Ingrese el Usuario", type : "warning", timeout: 4000});
		     $(this).removeClass("processing");
		     return false;
		 }else if(!user.match(nameRegex)){				    	 		     
		     noty({text:"Ha introducido un usuario invalido", type : "warning", timeout: 4000});
		     $(this).removeClass("processing");
		     return false;
		 }else if(pass==""){						 		     
		     noty({text:"Ingrese su Password", type : "warning", timeout: 4000});
		     $(this).removeClass("processing");
		     return false;
		 }
	    
	    $('#formLogin #key1').val(-12);

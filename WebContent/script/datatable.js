...
$.fn.pageFill = function(data){
    var listElement = this;
    $(listElement).html('');
    jQuery.each(data, function(index, el) {
        var tr = document.createElement("tr");
        
        jQuery.each(el, function(index_sub, el_sub) {
                $(tr).append('<td>'+el_sub+'</td>');
        });
...
$.fn.pageSelec = function(){
    var listElement = this;
    jQuery.each($(listElement).find('tr'), function(index, el) {

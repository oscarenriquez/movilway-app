...
public interface PuntoVentaDao<T> extends GenericDao<T>  {
	...
	public List<PuntoVenta> getListaPuntoVentaFiltered(Long tipoPuntoVentaPadre, Long empresaId, String[] tiposPuntoVenta, String puntoVentaSuperior, String nivel, 

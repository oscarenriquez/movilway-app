...
@WebFilter(filterName = "HibernateFilterReset", urlPatterns = { "/Reset" })
public class HibernateSessionRequestResetFilter implements Filter {
	...
	private void logException(ServletRequest request, ServletResponse response, Throwable e) throws IOException, ServletException {
        ...
        alerta.enviarAlerta("HibernateFilterReset", e, "", ServicioHelper.EMAIL);
        alerta = null;
	...
	private void logFilterException(ServletRequest request, ServletResponse response, Throwable e) throws IOException, ServletException {		
		 Alerta alerta = new Alerta();
	     alerta.enviarAlerta("HibernateSessionRequestResetFilter", e, "", ServicioHelper.EMAIL);
	     alerta = null;
	}
}

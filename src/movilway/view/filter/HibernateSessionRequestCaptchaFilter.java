...
@WebFilter(filterName = "HibernateFilterCaptcha", urlPatterns = { "/Captcha" })
public class HibernateSessionRequestCaptchaFilter implements Filter {
	...
	private void logException(ServletRequest request, ServletResponse response, Throwable e) throws IOException, ServletException {
        ...
        alerta.enviarAlerta("HibernateFilterCaptcha", e, "", ServicioHelper.EMAIL);
        alerta = null;
	...
	private void logFilterException(ServletRequest request, ServletResponse response, Throwable e) throws IOException, ServletException {		
		 Alerta alerta = new Alerta();
	     alerta.enviarAlerta("HibernateSessionRequestCaptchaFilter", e, "", ServicioHelper.EMAIL);
	     alerta = null;
	}
}

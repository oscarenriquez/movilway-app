...
@WebFilter(filterName = "HibernateFilterMensaje", urlPatterns = { "/Mensaje" })
public class HibernateSessionRequestMensajeFilter implements Filter {
	...
	private void logException(ServletRequest request, ServletResponse response, Throwable e) throws IOException, ServletException {
        ...
        alerta.enviarAlerta("HibernateFilterMensaje", e, "", ServicioHelper.EMAIL);
        alerta = null;
	...
	private void logFilterException(ServletRequest request, ServletResponse response, Throwable e) throws IOException, ServletException {		
		 Alerta alerta = new Alerta();
	     alerta.enviarAlerta("HibernateSessionRequestMensajeFilter", e, "", ServicioHelper.EMAIL);
	     alerta = null;
	}//HibernateUtil.closePool();
}

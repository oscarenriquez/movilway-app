...
@WebFilter(filterName = "HibernateFilterConstante", urlPatterns = { "/Constante" })
public class HibernateSessionRequestConstanteFilter implements Filter {
	...
	private void logException(ServletRequest request, ServletResponse response, Throwable e) throws IOException, ServletException {
        ...
        alerta.enviarAlerta("HibernateFilterConstante", e, "", ServicioHelper.EMAIL);
        alerta = null;
	...
	private void logFilterException(ServletRequest request, ServletResponse response, Throwable e) throws IOException, ServletException {				
		 Alerta alerta = new Alerta();
	     alerta.enviarAlerta("HibernateSessionRequestConstanteFilter", e, "", ServicioHelper.EMAIL);
	     alerta = null;
	}
}
